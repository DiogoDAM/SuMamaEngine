...
namespace SuMamaLib
{
	public class UiSimpleHotbar : UiComponent
	{
		...
		public UiSimpleHotbar(int quant, int w, int h, Color color) : base()
		{
			ItemsQuantity = quant;
		...
		public UiSimpleHotbar(Transform trans, int quant, int w, int h, Color color) : base(trans)
		{
			ItemsQuantity = quant;
			_items = new UiComponent[quant];
			HotbarLayout = new UiLinearLayout(this, Vector2.Zero);
